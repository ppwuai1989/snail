cc.Class({
    ...
    login: function () {
        ...
        var url = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxe96bbd4187ab4e71&redirect_uri=http://paopao.viphk.ngrok.org/portal/weChat/weChatLogin.do&response_type=code&scope=snsapi_userinfo#wechat_redirect"
        // var url = "www.baidu.com"
        // var url = "http://192.168.1.171:9000/portal/weChat/weChatLogin.do"
    ...
    share: function (title, desc) {
        if (cc.sys.os == cc.sys.OS_ANDROID) {
            ...
            jsb.reflection.callStaticMethod(this.IOS_API, "share:shareTitle:shareDesc:", cc.sx.SI.appweb, title, desc);
        }
        else {
            console.log("platform:" + cc.sys.os + " dosn't implement share.");
        }
