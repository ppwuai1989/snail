				...
				<div class="widget-box widget-color-blue">
					...
					<div class="widget-header">
						<h5 class="widget-title bigger lighter">
							<i class="ace-icon fa fa-table"></i> 系统通知<a href="#"
								onClick="moreNotice()" style="color: #ffffff;">>></a>
						</h5>
						...
						<div class="widget-main">
							...
							<script type="text/javascript">
								...
								function chartGetData() {
									d = new Date(), nowYear = +d.getFullYear();
									var array = new Array();
									var datas;
									$
											.ajax({
								...
								function getChartData() {
									...
									$
											.ajax({
												type : "post",
												url : contextPath
														+ "/data/findFamilyPlanningSalvationCost.do",
												data : {
													year : nowYear
												},
												success : function(rst) {
								...
								function getOutpData() {
									...
									$
											.ajax({
												type : "post",
												url : contextPath
														+ "/data/findOutpCostByAreacode.do",
												data : {
													year : nowYear
												},
												success : function(rst) {
								...
								function getAllChartData() {
									...
									$
											.ajax({
												type : "post",
												url : contextPath
														+ "/data/findCivilAffairsSalvationCost.do",
												data : {
													year : nowYear
												},
												success : function(rst) {
