				...
				<div class="widget-main padding-6">
					<div>
						所属地区： <select class="easyui-combotree"
							...
							data-options="url:'${pageContext.request.contextPath}/system/selectProvinceTreeList.do?pid=520202',required:false">
