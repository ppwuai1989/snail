jQuery(function($) {
	...
	$("#bootbox-options").on(ace.click_event, function() {
		bootbox.dialog({
			// message: "<span class='bigger-110'>I am a custom dialog with
			// smaller buttons</span>",
			title : 'widget-box',
...
/*
 * function append(){ var t = $('#tt'); var node = t.tree('getSelected');
 * t.tree('append', { parent: (node?node.target:null), data: [{ text: 'new
 * item1' },{ text: 'new item2' }] }); } function removeit(){ var node =
 * $('#tt').tree('getSelected'); $('#tt').tree('remove', node.target); }
 */
function collapse() {
	var node = $('#tt').tree('getSelected');
